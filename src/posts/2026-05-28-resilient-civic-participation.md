...
The European Citizens' Initiative, the EU's only direct-democracy instrument, requires signers in 18 of 27 member states to surrender their [national identifier or passport number](https://citizens-initiative.europa.eu/data-requirements_en), along with full name, address, date of birth, and nationality, to a state verifying authority. The ECI is well-regulated and GDPR-compliant.
