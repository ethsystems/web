...
A funder funds a pool, the recipient's smartcard produces a one-time claim, a relay does the heavy proving, and Ethereum settles the payment to a fresh address. No party along the path holds a record linking the recipient's enrollment to the on-chain claim or to the address that later cashes out.
